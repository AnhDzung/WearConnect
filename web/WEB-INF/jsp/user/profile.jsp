...
<head>
    ...
    <style>
        ...
        .role { display: inline-block; padding: 6px 12px; border-radius: 999px; background: #eef2ff; color: #4338ca; font-weight: 600; font-size: 12px; }
...
<%
    Model.Account user = (Model.Account) session.getAttribute("account");
    if (user == null) {
        response.sendRedirect(request.getContextPath() + "/login");
        return;
    }
    String displayName = (user.getFullName() != null && !user.getFullName().trim().isEmpty()) ? user.getFullName() : user.getUsername();
%>
...
<div class="container">
    ...
    <div class="profile-card">
        ...
        <div class="info-grid">
            ...
            <div class="info-item">
                ...
                <div class="value"><%= (user.getFullName() != null) ? user.getFullName() : "" %></div>
            </div>
            <div class="info-item">
                <div class="label">Email</div>
                <div class="value"><%= (user.getEmail() != null) ? user.getEmail() : "" %></div>
            </div>
            <div class="info-item">
                <div class="label">Số điện thoại</div>
                <div class="value"><%= (user.getPhoneNumber() != null) ? user.getPhoneNumber() : "" %></div>
            </div>
            <div class="info-item">
            ...
            <%
                ...
                try {
                    if (user.getBankAccountNumber() != null && !user.getBankAccountNumber().isEmpty()) {
                        bankAccountDisplay = user.getBankAccountNumber();
                    }
                } catch (Exception e) {
                ...
                try {
                    if (user.getBankName() != null && !user.getBankName().isEmpty()) {
                        bankNameDisplay = user.getBankName();
                    }
                } catch (Exception e) {
                    // Field not exists in database yet
                }
        ...
        <div class="actions">
            ...
            <button class="btn btn-edit" onclick="openChangePasswordModal()" style="background: #28a745;">🔐 Đổi mật khẩu</button>
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form id="editForm" method="POST" action="${pageContext.request.contextPath}/user?action=updateProfile">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="phoneNumber" name="phoneNumber" value="<%= (user.getPhoneNumber() != null) ? user.getPhoneNumber() : "" %>">
                </div>
                <div class="form-group">
                ...
                <%
                    ...
                    try {
                        bankAccountValue = (user.getBankAccountNumber() != null) ? user.getBankAccountNumber() : "";
                    } catch (Exception e) {}
                    try {
                        bankNameValue = (user.getBankName() != null) ? user.getBankName() : "";
                    } catch (Exception e) {}
                %>
                <div class="form-group">
    ...
    <div id="changePasswordModal" class="modal">
        <div class="modal-content">
            ...
            <form id="changePasswordForm" method="POST" action="${pageContext.request.contextPath}/user?action=changePassword">
                <div class="form-group">
