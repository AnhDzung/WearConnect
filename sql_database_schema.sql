...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='RentalOrder' AND COLUMN_NAME='RefundProofImage')
    ALTER TABLE RentalOrder ADD RefundProofImage NVARCHAR(MAX) NULL;
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='RentalOrder' AND COLUMN_NAME='ManagerPaymentProofImage')
    ALTER TABLE RentalOrder ADD ManagerPaymentProofImage NVARCHAR(MAX) NULL;
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='RentalOrder' AND COLUMN_NAME='PaymentProcessedDate')
    ALTER TABLE RentalOrder ADD PaymentProcessedDate DATETIME NULL;
